        ...
        if(key != keypad.NULL):     #if there is key pressed, print its key code.
            ...
            if(len(saisie) == len(reponse)):
                ...
                if(saisie == reponse):
                    ...
                    sleep(4)
                    display.lcd_clear()
                    long_string(display, "Patio 1 :" ,1)
                    long_string(display, "Classique" ,2)
                    sleep(1.5)
                    display.lcd_clear()
                    long_string(display, "Patio 2 :" ,1)
                    long_string(display, "Jazz" ,2)
                    sleep(1.5)
                    display.lcd_clear()
                    long_string(display, "Patio 3 :" ,1)
                    long_string(display, "Country" ,2)
                    sleep(1.5)
                    display.lcd_clear()
                    long_string(display, "Patio 4 :" ,1)
                    long_string(display, "Reggae" ,2)
